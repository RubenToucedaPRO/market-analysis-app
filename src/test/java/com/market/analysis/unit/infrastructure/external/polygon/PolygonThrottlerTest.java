...
class PolygonThrottlerTest {

        @Test
        void shouldAllowCallsWithinBudgetWithoutWaiting() {
                PolygonThrottler throttler = new PolygonThrottler(3, 60_000);
        ...
        void shouldWaitUntilOldestCallExpiresWhenBudgetExceeded() {
                PolygonThrottler throttler = new PolygonThrottler(2, 400);
        ...
        @Test
        void shouldAllowImmediateCallAfterWindowSlides() {
                PolygonThrottler throttler = new PolygonThrottler(1, 200);
